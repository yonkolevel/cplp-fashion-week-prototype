      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="mt-12 flex flex-wrap items-center gap-6 border-t py-6 flex-col md:flex-row md:justify-between">
          ...
          <div className="order-last flex justify-center md:order-first md:justify-start">
            <Link href="/" aria-label="go home" className="cplp-footer-mark">
              <span>CPLP</span>
              <small>FASHION WEEK</small>
            </Link>
            <span className="self-center text-muted-foreground text-sm ml-4">© {new Date().getFullYear()} {header?.name}, All rights reserved</span>
          </div>
